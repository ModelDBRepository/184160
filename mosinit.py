'''
Current clamp demo using Allen Brain's model 471087975.
...
from neuron471087975 import Neuron471087975
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron471087975(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 471087975; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-90.7508341471)
        h.fcurrent()
